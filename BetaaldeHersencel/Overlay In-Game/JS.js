...
window.addEventListener("onWidgetLoad",function(o){var p={"bottom-left":["48px","","","110px"],"bottom-right":["","48px","","110px"],"top-left":["48px","","130px",""],"top-right":["","48px","130px",""]}[o.detail.fieldData.camCorner||"bottom-left"];var c=document.querySelector(".bh-cam");c.style.left=p[0];c.style.right=p[1];c.style.top=p[2];c.style.bottom=p[3];});
