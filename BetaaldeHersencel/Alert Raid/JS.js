...
window.addEventListener("onEventReceived",function(o){var l=o.detail.listener,ev=o.detail.event||{};if(l!=="raid-latest")return;if(ev.name===undefined&&ev.data)ev=ev.data;try{q(".bh-name").textContent=ev.name;q(".bh-msg").textContent=(ev.amount||0)+" braincells arriving";}catch(e){}var r=q(".bh-alert");r.classList.add("bh-show");clearTimeout(bhT);bhT=setTimeout(function(){r.classList.remove("bh-show");},bhDur*1000);});
